import pygame
from code_d2.settings import tile_size, vertical_tile_number, screen_width
from code_d2.tiles import AnimatedTile, StaticTile
...
class Water:
    def __init__(self, top, level_width):
        ...
        for tile in range(tile_x_amount):
            ...
            y = top
            sprite = AnimatedTile(192, x, y, '../graphics/decor/water')
...
class Clouds:
    def __init__(self, horizon, level_width, cloud_number):
        cloud_surf_list = import_folder('../graphics/decor/clouds')
        min_x = -screen_width
